...
<div class="container-fluid">
  <!-- Page Heading --> 
  <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-utensils" style="font-size: 30px;"></i> Crear plan de alimentación</h1>
  <p class="mb-4">Formulario para registar plan de alimentación.</p>
  <!-- DataTales Example -->
  ...
  <div class="form-row">
    <div class="form-group col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="nombrePlan" placeholder="Nombre" required>
    </div>
    <div class="form-group col-md-4 mb-3">
      <label for="inputPassword4">*Kcal totales:</label>
      <input type="text" class="form-control" id="kcaltotal" placeholder="Kcal totales" required>
    </div>
    <div class="form-group col-md-4 mb-3">
      <label for="inputPassword4">*HC:</label>
      <input type="text" class="form-control" id="hc" placeholder="HC" required>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col">
      ...
      <input type="time" class="form-control" id="hdesayuno" placeholder="Desayuno" required>
    </div>
    <div class="form-group col">
      <label for="inputPassword4">*Colación 1:</label>
      <input type="time" class="form-control" id="hcolacion1" placeholder="Colación" required>
    </div>
    <div class="form-group col">
      <label for="inputPassword4">*Comida:</label>
      <input type="time" class="form-control" id="hcomida" placeholder="Comida" required>
    </div>
    <div class="form-group col">
      <label for="inputPassword4">*Colación 2:</label>
      <input type="time" class="form-control" id="hcolacion2" placeholder="Colación" required>
    </div>
    <div class="form-group col">
      <label for="inputPassword4">*Cena:</label>
      <input type="time" class="form-control" id="hcena" placeholder="Cena" required>
    </div>
  </div>
  ...
  <div class="col text-center">
  <button  id="guardarPlan" type="submit" class="btn btn-outline-primary btn-rounded waves-effect"> Guardar</button>
  </div>
</div>
</form>
</div>
