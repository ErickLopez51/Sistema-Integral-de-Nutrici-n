...
<div class="container-fluid">
  <!-- Page Heading --> 
  <h1 class="h3 mb-2 text-gray-800">  <i class="fas fa-utensils" style="font-size: 30px;"></i> Planes de alimentación</h1>
  <p class="mb-4">Gestionar planes de alimentación.</p>
  <!-- DataTales Example -->
  <div class="card shadow mb-3">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Planes de alimentación registrados.</h6> 
            <span class="float-right">
       <a href="?c=PlanesdeAlimentacion&a=VistaAltaPlan" class="btn btn-primary btn-icon-split">
        <span class="icon text-white-50">
         <i class="fas fa-plus"></i>
       </span>
       <span class="text">Crear plan de alimentación</span>
     </a></span> 
      <br>
      <br>
  <div class="card shadow mb-3">
