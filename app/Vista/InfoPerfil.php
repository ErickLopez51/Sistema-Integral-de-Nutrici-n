      ...
      <form  id="frm-crearGrupo" action="" method="post" enctype="multipart/form-data">
       <div class="row">
        <div class="form-group col-5">
          ...
          <input disabled type="text" class="form-control" title="Nombre" id="nombre">
        </div>
        <div class="form-group col-5">
         <label for="exampleFormControlSelect1">Correo:</label>
         <input disabled type="text" class="form-control" title="Correo" id="correo"> 
       </div>

        <div class="form-group col-5">
         <label for="exampleFormControlSelect1">Dirección:</label>
         <input disabled type="text" class="form-control" title="Area" id="direccion"> 
       </div>
        <div class="form-group col-5">
         <label for="exampleFormControlSelect1">Teléfono:</label>
         <input disabled type="text" class="form-control" title="Subarea" id="telefono"> 
       </div>
       <div class="col-5">
