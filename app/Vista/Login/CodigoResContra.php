...
<head>
  ...
  <link href="/sin/Public/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
         ...
         <div class="wrapper">
          <div id="formContent" class="border border-danger">
            ...
            <form method="POST" id="frmCodigoRecuperar" action="?c=Usuarios&a=validarCodigo">
              <label for="exampleFormControlInput1">Ingresa un código de verificación.<br> Se envió un mensaje al correo electrónico con un código de verificación.</label>
              <!-- tiempo -->
              <br>
              <div>
              ...
              <br>
              <input type="text" id="codigoRecuperar" name="codigoRecuperar" placeholder="Ingresar código">
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
               <a class="underlineHover" href="?c=Usuarios&a=RestablecerContra">Volver a enviar código</a> 
           </div>
           <br>
            <!-- Footer -->
        ...
        <script src="/sin/Public/js/appJS/RecuperarContrasena.js"></script>
          <script src="/sin/Public/js/appJS/Tiempo.js"></script>
